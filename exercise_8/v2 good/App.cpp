...
void App::RunApp() {
	...
	scene1->addLight(0, 2, true, glm::vec3(3.0, 3.0, 10.0), glm::vec3(1.0, 1.0, 0.5), 1.9, 0.01f, 0.05f, false);
	scene1->setLightAttenuation(0, scene1->getSizeLight(0) - 1, -1, 0.02, 0.13, 30);
