...
public:
	...
	void addLight(int idDOShader, glm::vec3 lightPos, bool randomMovement);
	void addLight(int idDOShader, glm::vec3 lightPos, glm::vec3 color, bool randomMovement);
	void addLight(int idDOShader, glm::vec3 lightPos, glm::vec3 color, float intensity, float ambientStrength, float specularStrength, bool randomMovement);
