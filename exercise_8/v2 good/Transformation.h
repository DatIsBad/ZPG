...
// Forward declaration of transformation classes
class Translate;
class Rotate;
class Scale;
...
public:
	...
	virtual glm::mat4 getValue();
	

	void changeTranslation(int at, const glm::vec3& newTranslation);
	void changeRotation(int at, float newAngle, const glm::vec3& newAxis);
	void changeScale(int at, const glm::vec3& newScale);

	void makeMeRotateConst(int at);
	int getSize();
