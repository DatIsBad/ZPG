...
void App::RunApp() {
	...
	scene1->addLight(0, 1, false, glm::vec3(3.0, 3.0, 10.0), glm::vec3(1.0, 1.0, 0.5), 0.3, 0.01f, 0.05f, true);
	scene1->setLightAttenuation(0, scene1->getSizeLight(0) - 1, -1, -1, -1, 5);
	scene1->addLight(0, 1, false, glm::vec3(3.0, 3.0, 3.0), glm::vec3(1.0, 1.0, 0.5), 0.3, 0.01f, 0.05f, true);
	scene1->setLightAttenuation(0, scene1->getSizeLight(0) - 1, -1, -1, -1, 5);
	scene1->addLight(0, 1, false, glm::vec3(2.0, 3.0, -2.0), glm::vec3(1.0, 1.0, 0.5), 0.3, 0.01f, 0.05f, true);
	scene1->setLightAttenuation(0, scene1->getSizeLight(0) - 1, -1, -1, -1, 5);
	scene1->addLight(0, 1, false, glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 0.5), 0.3, 0.01f, 0.05f, true);
	scene1->setLightAttenuation(0, scene1->getSizeLight(0) - 1, -1, -1, -1, 5);

	// cone/reflector light attached to camera
	scene1->addLight(0, 2, true, glm::vec3(3.0, 3.0, 10.0), false);
	scene1->setLightAttenuation(0, scene1->getSizeLight(0) - 1, -1, -1, -1, 30);

	//scene1->addLight(0, 3, false, glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 0.5), 0.1, 0.01f, 0.05f, false);
